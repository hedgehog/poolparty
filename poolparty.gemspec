...
Gem::Specification.new do |s|
  ...
  s.executables = ["cloud-contract", "cloud-expand", "cloud-terminate", "cloud-bootstrap", "cloud-rsync", "cloud-list", "cloud-run", "cloud-configure", "cloud-show", "cloud-compile", "cloud-ssh", "cloud-start", "cloud", "cloud-reboot", "cloud-vnc", "cloud-console"]
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
